...
## 2026-09-17 P0 / P1 / P2 第四批复核

旧记录的 passed 仅适用于当时检查范围。此后产品与代码发生变化，本轮按先推送后检查完成隔离 Demo 的榜单、图表、账户、邮件设置、保存筛选、组件网格与页脚验收。最新证据、发现的问题和未验证范围见 [第四批验收报告](docs/qa/p0-p2/UI_ACCEPTANCE_2026-09-17.md)。

保留黑白蓝和方形控件；首字母头像与账户菜单、Free / Pro 和邮件状态分离。生产性能、真机、缩放 / 减少动效以及真实服务联调继续待验收。
